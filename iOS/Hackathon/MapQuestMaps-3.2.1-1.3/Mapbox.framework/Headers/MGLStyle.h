...
+ (NSURL *)mqStreetsOpenStyleURL;

+ (NSURL *)mqStreetsTomTomStyleURL;

+ (NSURL *)mqSatelliteOpenStyleURL;

+ (NSURL *)mqSatelliteTomTomStyleURL;

+ (NSURL *)mqNightModeOpenStyleURL;

+ (NSURL *)mqNightModeTomTomStyleURL;

+ (NSURL *)mqDebugStreetsOpenStyleURL;

+ (NSURL *)mqDebugStreetsTomTomStyleURL;

+ (NSURL *)mqDebugSatelliteOpenStyleURL;

+ (NSURL *)mqDebugSatelliteTomTomStyleURL;

+ (NSURL *)mqDebugNightModeOpenStyleURL;

+ (NSURL *)mqDebugNightModeTomTomStyleURL;
